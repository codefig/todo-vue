...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-5d764ff4", Component.options)
  } else {
    hotAPI.reload("data-v-5d764ff4", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_Add_vue__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_Add_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3__components_Add_vue__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__components_Home_vue__ = __webpack_require__(4);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__event_bus_js__ = __webpack_require__(22);
...
var app = new __WEBPACK_IMPORTED_MODULE_0_vue___default.a({
	...
	components: {
		'Add': __WEBPACK_IMPORTED_MODULE_3__components_Add_vue___default.a,
		'Home': __WEBPACK_IMPORTED_MODULE_4__components_Home_vue___default.a
	},
	store: __WEBPACK_IMPORTED_MODULE_5__event_bus_js__["a" /* default */]
});
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    fetchTask: function fetchTask(taskId) {
      ...
      axios.get('/fetch/' + taskId).then(function (response) {
        console.log(response);
        _this.title = response.data.title;
        _this.description = response.data.description;
        _this.taskId = response.data.id;
      });
    ...
    capitalize: function capitalize(value, start, end) {
  ...
  return _c("div", [
    _c("section", { staticClass: "container" }, [
      _c("table", { staticClass: "table" }, [
        ...
        _c(
          "tbody",
          _vm._l(_vm.tasks, function(items, index) {
            return _c("tr", { key: index }, [
              _c("th", [_vm._v(_vm._s(items.id))]),
              _vm._v(" "),
              _c("td", [_vm._v(_vm._s(_vm._f("capitalize")(items.title)))]),
              _vm._v(" "),
              _c("td", [_vm._v(_vm._s(items.description))]),
              _vm._v(" "),
              _c("td", [
                _c(
                  "a",
      ...
      _vm._v(" "),
      _c("div", { class: _vm.modalClass, attrs: { id: "modal" } }, [
              ...
              _c("div", { staticClass: "field" }, [
                _c("div", { staticClass: "control" }, [
                  _c("textarea", {
                    ...
                    attrs: { placeholder: "Edit Description" },
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-18fa0fdd", Component.options)
  } else {
    hotAPI.reload("data-v-18fa0fdd", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__PostElement_vue__ = __webpack_require__(16);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__PostElement_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__PostElement_vue__);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
  components: {
    'post-element': __WEBPACK_IMPORTED_MODULE_0__PostElement_vue___default.a
  },
  data: function data() {
    return {
      posts: [{ 'id': 1, "name": "Moshood" }, { 'id': 2, 'name': "barbanas" }, { 'id': 3, "name": "asari dokubo" }],
      username: "Moshood Alaran"
    };
  }
});
...
Component.options.__file = "resources/js/components/PostElement.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-56b3a721", Component.options)
  } else {
    hotAPI.reload("data-v-56b3a721", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
var render = function() {
  ...
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("div", {}, [_vm._t("header"), _vm._v(" "), _vm._t("content")], 2)
}
var staticRenderFns = []
render._withStripped = true
module.exports = { render: render, staticRenderFns: staticRenderFns }
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-56b3a721", module.exports)
  }
}
...
var render = function() {
  ...
  return _c("div", { staticClass: "container" }, [
    _c("h1", [_vm._v("Trash Component")]),
    _vm._v(" "),
    _c(
      "ul",
      _vm._l(_vm.posts, function(post, id) {
        return _c(
          "div",
          { key: id },
          [
            _c("post-element", { attrs: { post: post } }, [
              _c("h3", { attrs: { slot: "header" }, slot: "header" }, [
                _vm._v("Element : " + _vm._s(post.id))
              ]),
              _vm._v(" "),
              _c(
                "div",
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-18fa0fdd", module.exports)
  }
}
    ...
    addTask: function addTask() {
      ...
      axios.post("/add", {
        ...
        if (response.data.success) {
          ...
          _this.title = "";
          _this.description = "";
          _this.errClass = "notification is-primary";
          _this.errors = response.data;
        } else {
          _this.errClass = "notification is-danger";
          _this.errors = response.data;
        }
      });
    }
  ...
  return _c("div", [
    _c("div", { staticClass: "container" }, [
              ...
              _c("div", { staticClass: "field" }, [
                _c("div", { staticClass: "control" }, [
                  _c("textarea", {
                    ...
                    staticClass: "textarea",
                    attrs: { id: "description", placeholder: "I want to ..." },
                    domProps: { value: _vm.description },
                    on: {
                      input: function($event) {
                        if ($event.target.composing) {
      ...
      _c(
        "div",
        { class: _vm.errClass },
        _vm._l(_vm.errors, function(key, index) {
          return _c("li", { key: index }, [_vm._v(_vm._s(key))])
        })
      )
    ])
  ])
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-5d764ff4", module.exports)
  }
}
